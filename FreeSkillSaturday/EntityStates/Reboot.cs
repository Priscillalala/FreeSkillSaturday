...
namespace EntityStates.Toolbot
{
    public class Reboot : BaseCharacterMain
    {
        ...
        {
            base.OnEnter();
            duration = (FreeItemFriday.Skills.Reboot.duration / attackSpeedStat) + entryDuration;
            ...
            {
                prefab = FreeItemFriday.Skills.Reboot.RebootOverlay,
        ...
        public void CleanseBodyStep()
        {
            ...
            EffectManager.SpawnEffect(FreeItemFriday.Skills.Reboot.VentEffect, new EffectData
            {
